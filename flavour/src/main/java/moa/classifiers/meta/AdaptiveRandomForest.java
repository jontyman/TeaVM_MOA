...
public class AdaptiveRandomForest extends AbstractClassifier implements MultiClassClassifier,
	...
	public Options getOptions(){
		Option[] myOptions = {treeLearnerOption,ensembleSizeOption,mFeaturesModeOption,mFeaturesPerTreeSizeOption,lambdaOption,numberOfJobsOption,driftDetectionMethodOption,warningDetectionMethodOption,disableWeightedVote,disableDriftDetectionOption,disableBackgroundLearnerOption};
	...
	public AdaptiveRandomForest(){
		...
		this.mFeaturesModeOption.setChosenIndex(3);
		this.mFeaturesPerTreeSizeOption.setValue(60);
		this.lambdaOption.setValue(6.0f);
		this.numberOfJobsOption.setValue(1);
    ...
    public double[] getVotesForInstance(Instance instance) {
        Instance testInstance = (Instance) instance;//Instance testInstance = instance.copy();
        if(this.ensemble == null) 
...
//        BasicClassificationPerformanceEvaluator classificationEvaluator = (BasicClassificationPerformanceEvaluator) getPreparedClassOption(this.evaluatorOption);
        ...
        for(int i = 0 ; i < ensembleSize ; ++i) {
            ...
            this.ensemble[i] = new ARFBaseLearner(
                i, 
                (ARFHoeffdingTree) treeLearner, //(ARFHoeffdingTree) treeLearner.copy(), 
                (BasicClassificationPerformanceEvaluator) classificationEvaluator,//(BasicClassificationPerformanceEvaluator) classificationEvaluator.copy(), 
                this.instancesSeen, 
            ...
            if(this.useDriftDetector && !this.isBackgroundLearner) {
                ...
                if(this.useBkgLearner) {
                    ...
                    if(this.warningDetectionMethod.getChange()) {
                        ...
                        ARFHoeffdingTree bkgClassifier = (ARFHoeffdingTree) this.classifier;//ARFHoeffdingTree bkgClassifier = (ARFHoeffdingTree) this.classifier.copy();

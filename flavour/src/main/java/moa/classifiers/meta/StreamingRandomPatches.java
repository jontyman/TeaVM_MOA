...
public class StreamingRandomPatches extends AbstractClassifier implements MultiClassClassifier,
	...
	public Options getOptions(){
		Option[] myOptions = {baseLearnerOption,ensembleSizeOption,subspaceModeOption,subspaceSizeOption,trainingMethodOption,lambdaOption,driftDetectionMethodOption,warningDetectionMethodOption,disableWeightedVote,disableDriftDetectionOption,disableBackgroundLearnerOption};
	...
	public StreamingRandomPatches(){
		this.ensembleSizeOption.setValue(100);
		this.subspaceModeOption.setChosenIndex(1);
		this.subspaceSizeOption.setValue(60);
		this.trainingMethodOption.setChosenIndex(1);
		this.lambdaOption.setValue(6.0f);
		this.disableWeightedVote.setValue(false);
		this.disableDriftDetectionOption.setValue(false);
		this.disableBackgroundLearnerOption.setValue(false);
    ...
    public double[] getVotesForInstance(Instance instance) {
		...
		Instance testInstance = (Instance) instance;
    ...
    protected void initEnsemble(Instance instance) {
		...
		//Classifier baseLearner = (Classifier) this.baseLearnerOption;
            ...
            switch(this.trainingMethodOption.getChosenIndex()) {
                case StreamingRandomPatches.TRAIN_RESAMPLING:
                    this.ensemble[i] = new StreamingRandomPatchesClassifier(
                            i,
                            (Classifier) baseLearner,//baseLearner.copy(), //Class java.io.ObjectOutputStream was not found
                            (BasicClassificationPerformanceEvaluator) classificationEvaluator,// //Class java.io.ObjectOutputStream was not found(BasicClassificationPerformanceEvaluator) classificationEvaluator.copy(),
                            this.instancesSeen,
                ...
                case StreamingRandomPatches.TRAIN_RANDOM_PATCHES:
                    ...
                    this.ensemble[i] = new StreamingRandomPatchesClassifier(
                            i,
                            (Classifier) baseLearner,//baseLearner.copy(), //Class java.io.ObjectOutputStream was not found
                             (BasicClassificationPerformanceEvaluator) baseLearner,// Class java.io.ObjectOutputStream was not found (BasicClassificationPerformanceEvaluator) classificationEvaluator.copy(),
                            this.instancesSeen,
                            this.disableBackgroundLearnerOption.isSet(),
                            this.disableDriftDetectionOption.isSet(),
                            this.driftDetectionMethodOption,
    ...
    protected class StreamingRandomPatchesClassifier {
        ...
        private void init(int indexOriginal, Classifier instantiatedClassifier,
            ...
            if(!this.disableDriftDetector) {
                ...
                this.driftDetectionMethod = (ChangeDetector) getPreparedClassOption(driftOption);//this.driftDetectionMethod = ((ChangeDetector) getPreparedClassOption(driftOption)).copy();
            }

            // Init Drift Detector for Warning detection.
            if(!this.disableBkgLearner) {
                this.warningOption = warningOption;
                this.warningDetectionMethod = (ChangeDetector) getPreparedClassOption(warningOption); //((ChangeDetector) getPreparedClassOption(warningOption)).copy();
            }
        ...
        public void reset(Instance instance, long instancesSeen, Random random) {
            ...
            if(!this.disableBkgLearner && this.bkgLearner != null) {
                ...
                this.evaluator.reset();
                this.createdOn = instancesSeen;
                  this.driftDetectionMethod = (ChangeDetector) getPreparedClassOption(this.driftOption); //this.driftDetectionMethod = ((ChangeDetector) getPreparedClassOption(this.driftOption)).copy();
        ...
        public void trainOnInstance(Instance instance, double weight, long instancesSeen, Random random) {
            ...
            if(this.subset != null) {
                ...
                Instance weightedInstance = (Instance)instance;//Instance weightedInstance = instance.copy();
        ...
        public void triggerWarning(Instance instance, long instancesSeen, Random random) {
            Classifier bkgClassifier = (Classifier) this.classifier;//Classifier bkgClassifier = this.classifier.copy();
            bkgClassifier.resetLearning();

            BasicClassificationPerformanceEvaluator bkgEvaluator = (BasicClassificationPerformanceEvaluator) this.evaluator;//BasicClassificationPerformanceEvaluator bkgEvaluator = (BasicClassificationPerformanceEvaluator) this.evaluator.copy();
            bkgEvaluator.reset();
            if(this.subset == null) {
            ...
            this.warningDetectionMethod = (ChangeDetector) getPreparedClassOption(this.warningOption);//this.warningDetectionMethod = ((ChangeDetector) getPreparedClassOption(this.warningOption)).copy();
        }

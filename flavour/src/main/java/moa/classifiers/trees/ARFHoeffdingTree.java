...
public class ARFHoeffdingTree extends HoeffdingTree {
	...
	public ARFHoeffdingTree(int maxByteSize,int numericEstimator, int splitCriterion, int memoryEstimatePeriod, int gracePeriod, float splitConfidence, float tieThreshold, boolean binarySplits, boolean stopMemManagement, boolean removePoorAtts, boolean noPrePrune, int leafprediction, int nbThreshold){

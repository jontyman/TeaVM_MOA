...
public class HoeffdingAdaptiveTree extends HoeffdingTree {
	...
	public HoeffdingAdaptiveTree(){
		//super(33554432, 0, 0, 1000000, 200, 0.0f, 0.05f, false, false, false, false, 2, 0);
		super();
	}

	
	// Added super constructor
	public HoeffdingAdaptiveTree(int maxByteSize,int numericEstimator, int splitCriterion, int memoryEstimatePeriod, int gracePeriod, float splitConfidence, float tieThreshold, boolean binarySplits, boolean stopMemManagement, boolean removePoorAtts, boolean noPrePrune, int leafprediction, int nbThreshold){
		super(maxByteSize, numericEstimator, splitCriterion, memoryEstimatePeriod, gracePeriod, splitConfidence, tieThreshold, binarySplits, stopMemManagement, removePoorAtts, noPrePrune, leafprediction, nbThreshold);
	}

...
public class RandomRBFGeneratorDrift extends RandomRBFGenerator {
	...
	public RandomRBFGeneratorDrift(int modelRandomSeed, int instanceRandomSeed, int numClasses, int numAtts, int numCentroids, float speedChange, int numDriftCentroids){
		super(modelRandomSeed,instanceRandomSeed, numClasses, numAtts, numCentroids);
		if (speedChange>= 0.0f){
			speedChangeOption.setValue(speedChange);
		}
		else{
			System.out.println("Invalid speedChange");
		}
		
		if (numDriftCentroids >= 0){
			numDriftCentroidsOption.setValue(numDriftCentroids);
		}
		else{
			System.out.println("Invalid numDriftCentroids");
		}
